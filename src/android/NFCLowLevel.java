...
public class NFCLowLevel extends CordovaPlugin {
    ...
    /**
     * sets internal NfcF state to connected. Now it is able to transceive
     */
        ...
        cordova.getThreadPool().execute(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    if (nfcF == null) {
                        Log.e(TAG, "No Tech");
                        callbackContext.error("No NfcF Tech");
                        return;
                    }

                    Log.e(TAG, nfcF.toString());
                    ...
                    Log.e(TAG, "Can't connect to NfcF", ex);
                }
            }
        });
    }
        ...
        cordova.getThreadPool().execute(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    byte[] responseAPDU = nfcF.transceive(commandAPDU);
        ...
        cordova.getThreadPool().execute(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Log.e(TAG, "Can't connect to NfcF", ex);
                    callbackContext.error("Could not connect to NfcF");
                }
            }
        });
    }
